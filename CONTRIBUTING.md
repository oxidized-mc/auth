...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/auth.git
cd auth
...
`oxidized-auth` is a library crate in the
...
Use `auth` as the scope for all changes to this crate.
